...
coarse_train = dict(
    ...
    lrate_featnet=1e-3,           # lr of the featnet to preduct view-dependent color
...
vq_model_and_render = deepcopy(fine_model_and_render)
vq_model_and_render.update(dict(
    use_vq=True,
    use_cosine_sim=False,
    codebook_size=4096,
))

vq_train = deepcopy(fine_train)

vq_train.update(dict(
   N_iters=10000,
