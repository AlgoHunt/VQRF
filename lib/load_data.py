...
from .load_blender import load_blender_data, load_my_llff_data
...
def load_data(args):
    ...
    elif args.dataset_type == 'my_llff':
        images, poses, render_poses, hwf, i_split = load_my_llff_data(args.datadir, args.half_res, args.testskip)
